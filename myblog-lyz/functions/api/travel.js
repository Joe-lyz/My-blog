...
async function seedDevelopmentTrip(env) {
  ...
  const now=new Date().toISOString(),trip={id,title:"夏日见面旅行",slug:"summer-meetup",description:"两个人分别出发，在北京汇合，一起去往西安与成都。",coverUrl:"",startDate:"2026-07-01",endDate:"2026-07-05",travelers:[{id:"person-a",name:"人物A",avatarUrl:"",color:"#b55b45",markerIcon:""},{id:"person-b",name:"人物B",avatarUrl:"",color:"#547b8d",markerIcon:""}],stops,segments:[segment("harbin-beijing",stops[0],stops[2],"person-a","plane",0),segment("shanghai-beijing",stops[1],stops[2],"person-b","train",1),segment("beijing-xian",stops[2],stops[3],"together","train",2),segment("xian-chengdu",stops[3],stops[4],"together","car",3)],createdAt:now,updatedAt:now};
